...
void singleGPUSearch() {
    ...
    unsigned int threadsPower = 22;//20;// 16; // 15 // keep threadsPower lower than 20
    ...
    unsigned int startSequencePower = 0;  // do not use 0
    unsigned int endSequencePower = 44;// 32;
